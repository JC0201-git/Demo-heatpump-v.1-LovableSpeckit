import { a5 as useRouter, T as reactExports, K as jsxRuntimeExports } from "./server-CzeLhqbS.js";
...
const LayoutGrid = createLucideIcon("layout-grid", __iconNode$5);
const __iconNode$4 = [
...
function makeDevices() {
  ...
  for (let i = 1; i <= 80; i++) {
    ...
    const installedAt = new Date(Date.now() - installedDaysAgo * 864e5).toISOString();
    const riskScore = status === "abnormal" ? randInt(70, 99) : status === "maintenance" ? randInt(45, 75) : status === "offline" ? randInt(35, 60) : randInt(5, 55);
    const lastHb = status === "offline" ? new Date(Date.now() - randInt(30, 600) * 6e4).toISOString() : new Date(Date.now() - randInt(5, 120) * 1e3).toISOString();
    ...
    arr.push({
      ...
      rankChange: pick(["up", "down", "flat", "flat"]),
      isRealApi: i <= 7,
      ...
      totalRunHours: randInt(500, 22e3)
    });
  }
  return arr;
}
...
function makeAlerts() {
  const arr = [];
  const sevPool = ["high", "high", "medium", "medium", "low"];
  const statusPool = [
    "open",
    "open",
    "in_progress",
  ...
  for (let i = 0; i < 60; i++) {
    ...
    const occurredAt = new Date(
      Date.now() - randInt(10, 60 * 24 * 30) * 6e4
    ).toISOString();
    ...
    arr.push({
      ...
      assignedAt: assigned ? new Date(new Date(occurredAt).getTime() + randInt(5, 60) * 6e4).toISOString() : null,
      resolvedAt: resolved ? new Date(
        new Date(occurredAt).getTime() + randInt(60, 600) * 6e4
      ).toISOString() : null,
      resolutionNote: resolved ? "現場更換零件並校正參數" : void 0
    });
  }
  return arr;
}
const alertsSeed = makeAlerts();
const technicians = TECH_NAMES.map((n, i) => ({
  id: `T${i + 1}`,
  name: n,
  activeWorkOrders: randInt(2, 9),
  monthlyClosed: randInt(8, 28)
}));
function genDailyPoints(deviceId, days = 30) {
...
function genIncidents(deviceId) {
  ...
  for (let i = 0; i < n; i++) {
    out.push({
      id: `I${deviceId}-${i}`,
      deviceId,
      occurredAt: new Date(Date.now() - randInt(1, 90) * 864e5).toISOString(),
...
function genWorkOrders(deviceId) {
  srand(parseInt(deviceId.replace(/\D/g, "")) * 17 + 9);
  const n = randInt(1, 5);
  const out = [];
  for (let i = 0; i < n; i++) {
    const dispatched = new Date(Date.now() - randInt(5, 200) * 864e5);
    const completed = srand() < 0.8 ? new Date(dispatched.getTime() + randInt(2, 72) * 36e5) : null;
    out.push({
      id: `WO-${deviceId}-${i + 1}`,
      deviceId,
...
const TECH_NAME_OPTIONS = TECH_NAMES;
const Ctx = reactExports.createContext(null);
function AppStateProvider({ children }) {
  const [devices$1, setDevices] = reactExports.useState(devices);
  const [alerts, setAlerts] = reactExports.useState(alertsSeed);
  const [apiDown, setApiDown] = reactExports.useState(false);
    ...
    const t = setInterval(() => {
      setDevices(
        (prev) => prev.map((d) => {
          ...
          const jitter = (n, amp) => +(n + (Math.random() - 0.5) * amp).toFixed(2);
          return {
            ...d,
  ...
  const value = reactExports.useMemo(
    ...
    [devices$1, alerts, apiDown, lastUpdate]
  );
...
const NAV = [
  ...
  { to: "/monthly-report", label: "月報雛形", icon: FileChartColumn },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "aside",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-14 flex items-center gap-2 px-4 border-b border-sidebar-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-md bg-primary flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-5 h-5 text-primary-foreground" }) }),
            !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground leading-tight", children: "熱泵維運" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground leading-tight", children: "HeatPump Monitor" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 py-3 space-y-1 px-2", children: NAV.map((n) => {
            const Icon = n.icon;
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                className: cn(
                  ...
                  active ? "bg-primary text-primary-foreground font-semibold" : "text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
                ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "收合側欄" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                children: [
                  ...
                  !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "登出" })
                ]
              }
            )
          ] })
...
function ApiBanner() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-0 z-30 bg-[#3b1414] border-l-4 border-destructive px-4 py-2 flex items-center gap-3 text-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(WifiOff, { className: "w-4 h-4 text-destructive flex-shrink-0" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive-foreground flex-1", children: "API 連線異常：部分設備即時資料可能過期，請稍候自動重試或手動重新整理。" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
...
function TopBar({ onMobileMenu }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "h-14 bg-card border-b border-border flex items-center px-4 gap-4 flex-shrink-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-sm font-medium text-foreground truncate", children: "熱泵設備運維監控平台" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground truncate", suppressHydrationWarning: true, children: [
        "最後資料更新 · ",
        fmtDateTime(lastUpdate.toISOString())
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-xs font-semibold", children: "維" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:block text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground font-medium leading-tight", children: "維運工程師" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground leading-tight", children: "demo@heatpump.tw" })
      ] })
    ] })
  ] });
}
function AppShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppStateProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shell, { children }) });
}
function Shell({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TopBar, { onMobileMenu: () => setMobileOpen(true) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ApiBanner, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-auto page-fade", children }, location.pathname)
    ] })
  ] });
}
export {
  ALERT_STATUS_LABEL as A,
  Briefcase as B,
  SEVERITY_COLOR as S,
  TECH_NAME_OPTIONS as T,
  WifiOff as W,
  ALERT_TYPE_OPTIONS as a,
  AppShell as b,
  SEVERITY_LABEL as c,
  STATUS_COLOR as d,
  STATUS_LABEL as e,
