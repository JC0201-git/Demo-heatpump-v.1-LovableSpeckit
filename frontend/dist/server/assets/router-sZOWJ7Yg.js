...
const appCss = "/assets/styles-BGj62nj5.css";
...
const Route$8 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "熱泵維運監控平台 | HeatPump Monitor" },
      { name: "description", content: "熱泵設備維運監控儀表板 — 即時掌握 80 台設備運轉狀態、告警處理與健康分析。" },
      { property: "og:title", content: "熱泵維運監控平台" },
      { property: "og:description", content: "熱泵設備維運監控儀表板 Demo" },
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "zh-TW", className: "dark", children: [
...
const $$splitComponentImporter$6 = () => import("./risk-DpSfFqK2.js");
const Route$7 = createFileRoute("/risk")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./overview-TuT3dCFn.js");
const Route$6 = createFileRoute("/overview")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./monthly-report-DijD63wz.js");
const Route$5 = createFileRoute("/monthly-report")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./login-C5YvtCVp.js");
const Route$4 = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./executive-BPqiwy3n.js");
const Route$3 = createFileRoute("/executive")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./alerts-D_HWeUW-.js");
...
const $$splitComponentImporter = () => import("./device._id-UcwfciHI.js");
const Route2 = createFileRoute("/device/$id")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const RiskRoute = Route$7.update({
  id: "/risk",
  path: "/risk",
  getParentRoute: () => Route$8
});
const OverviewRoute = Route$6.update({
  id: "/overview",
  path: "/overview",
  getParentRoute: () => Route$8
});
const MonthlyReportRoute = Route$5.update({
  id: "/monthly-report",
  path: "/monthly-report",
  getParentRoute: () => Route$8
});
...
const ExecutiveRoute = Route$3.update({
  id: "/executive",
  path: "/executive",
  getParentRoute: () => Route$8
});
...
const DeviceIdRoute = Route2.update({
  id: "/device/$id",
  path: "/device/$id",
  getParentRoute: () => Route$8
});
